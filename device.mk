...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/configs/android.hardware.sensor.dynamic.head_tracker.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.sensor.dynamic.head_tracker.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/configs/permissions/mediatek-ims-oem-plugin.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/mediatek-ims-oem-plugin.xml \
...
# Touch
PRODUCT_PACKAGES += \
    vendor.lineage.touch-service.devonf
